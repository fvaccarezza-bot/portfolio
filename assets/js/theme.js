...
@media (min-width: 2560px) {
    .home-title { transform:scale(1.5); transform-origin:center center; }
}
/* name-letter: tamaño nativo, sin width/height forzados */
...
/* THEY SAID IT — desktop only */
.desktop-testi-phrase {
    display: flex;
    justify-content: center;
    margin-bottom: 48px;
}
.desktop-testi-phrase img {
    display: block;
    width: auto;
    max-width: 100%;
}
@media (max-width: 768px) {
    .desktop-testi-phrase { display: none !important; }
}
@media (min-width: 2560px) {
    .desktop-testi-phrase img { transform: scale(1.5); transform-origin: center center; }
    .desktop-testi-phrase { margin-bottom: 150px; margin-top: 50px; }
}

/* THEY SAID IT — desktop only, mismo sistema que services-big */
.desktop-testi-wrap {
    position: relative;
    margin-top: 0;
    margin-bottom: 48px;
...
.desktop-testi-tag img:nth-child(2) {
    margin-bottom: -15px;
}
.desktop-testi-tag img:last-child {
    margin-bottom: 0;
}
@media (max-width: 768px) {
    .desktop-testi-wrap { display: none !important; }
    #mob-testi-tag {
...
@media (min-width: 769px) {
    .mob-somekind-phrase { display: none !important; }
}

/* ─── ULTRAWIDE: escala el bloque completo del hero ─── */
@media (min-width: 2560px) {
    .home-title {
        transform: scale(1.5);
...
@media (max-width:768px) {
    .name-letter { height:29px !important; }
    .home-title { gap:16px; }
    .name-line { gap:2px !important; }
}
@media (max-width: 768px) {
    #trusted-by-row { display: none !important; }
    .services-btns { margin-bottom: 40px !important; }
    ...
    /* Reveal connect button */
    .services-btns-connect {
        opacity: 0;
        transform: translateY(20px);
        transition: opacity 1.1s cubic-bezier(0.25,0.46,0.45,0.94), transform 1.1s cubic-bezier(0.25,0.46,0.45,0.94), color 0.4s ease !important;
    }
    .services-btns-connect.in-view {
        opacity: 1;
    ...
    .mobile-testimonials img.in-view {
        opacity: 1;
        transform: translateY(0);
    }
    ...
    .mob-about-text {
        ...
        font-size: 12px;
        font-weight: 400;
        color: var(--color-fede-fv, #3A3A39);
        ...
        transform: translateY(30px);
        opacity: 0;
        transition: transform 1.1s cubic-bezier(0.25,0.46,0.45,0.94) 0.15s, opacity 1.1s cubic-bezier(0.25,0.46,0.45,0.94) 0.15s;
    }
    .mob-about-text.in-view {
        transform: translateY(0);
        opacity: 1;
    }
    ...
    .mobile-hero-portfolio-label-inner {
        display: block;
        transform: translateY(110%);
        transition: transform 0.9s cubic-bezier(0.76,0,0.24,1);
    }
    .mobile-hero-portfolio-label-inner.revealed {
        transform: translateY(0);
    }
    .mobile-hero .mob-name-line {
        overflow: hidden;
        line-height: 1;
        margin: 0;
        display: flex;
    ...
    #mob-federico {
        width: calc(92vw * 309 / 407) !important;
        height: auto !important;
        transform: translateY(110%) !important;
    }
    #mob-federico.revealed {
    ...
    #mob-vaccarezza.revealed {
        transform: translateY(0) !important;
    }
    .mobile-hero .mob-name-line img.revealed {
        transform: translateY(0);
    }
    .mobile-hero .mob-name-line:last-child img {
    ...
    .mob-photo-mask {
        ...
        width: 100%;
        height: 0%;
        background: var(--tt-body-bg, #F5F4F0);
        z-index: 2;
        pointer-events: none;
        will-change: height;
    }
    ...
    .mobile-hero-photo img.mob-photo {
        display: block !important;
        width: 100% !important;
        height: auto !important;
    ...
    #works { padding-top: 0 !important; margin-top: 0 !important; }
    ...
    #title-works, #title-works a, #title-works a:hover, #title-works a:focus,
    .section-title.noise-fill-hover, .section-title.noise-fill-hover:hover {
    ...
    .mob-phrase-word.in-view {
        transform: translateY(0);
    }
    .mob-phrase-tags-overlay {
        position: absolute;
        top: 50%;
        left: 50%;
    ...
    .words-container .carousel,
    .words-container .stage {
        display: flex !important;
    ...
    .card a.media, .card .pgi-image-holder { border-radius: 3px !important; }
    ...
    .gallery .card {
        ...
        transition: opacity 1.0s cubic-bezier(0.25,0.46,0.45,0.94), transform 1.0s cubic-bezier(0.25,0.46,0.45,0.94) !important;
    }
...
@media (min-width: 769px) {
    .card .meta .meta-name,
    .card .meta .meta-num { display: none !important; }
    ...
    #title-hola.noise-fill-hover, #title-hola.noise-fill-hover:hover,
    #title-works.noise-fill-hover, #title-works.noise-fill-hover:hover,
    .noise-fill-hover, .noise-fill-hover:hover {
        -webkit-text-stroke: 0 !important;
        text-stroke: 0 !important;
        color: inherit !important;
        background: none !important;
...
@media (max-width: 768px) {
    /* Solo colores, sin tocar animaciones del tema */
    .tt-overlay-menu { background-color: var(--tt-body-bg, #F5F4F0) !important; }
    .tt-ol-menu-list > li > a,
    .tt-ol-submenu-list > li > a { color: #3A3A39 !important; -webkit-tap-highlight-color: transparent; }
    ...
    .tt-ol-submenu-trigger > a,
    .tt-ol-menu-toggle-btn,
    #tt-ol-menu-toggle-btn-wrap { -webkit-tap-highlight-color: transparent !important; }
}
...
<body id="body" class="tt-transition tt-boxed tt-smooth-scroll">
...
<div id="scroll-container">
    ...
    <div id="content-wrap">
        <div id="page-header" class="ph-full ph-cap-sm ph-image-cropped ph-image-cover-3">
            <div class="page-header-inner tt-wrap">
                ...
                <div class="ph-caption text-uppercase ph-caption-hover">
                    <div class="hover-fv">
                        <div style="overflow:hidden;"><div class="text-center color-fv min-titles spacing">Portfolio – 2026</div></div>
        ...
        <div id="page-content">
            <!-- MOBILE HERO (solo visible en mobile) -->
            <div class="mobile-hero" style="display:none;">
                ...
                <div class="mob-name-line">
                    <img src="./assets/img/federico-mobile.svg" alt="Federico" id="mob-federico" />
                </div>
                <div class="mob-name-line">
                    <img src="./assets/img/vaccarezza-mobile.svg" alt="Vaccarezza" id="mob-vaccarezza" />
                </div>
                <div class="mob-photo-wrap" style="display:none;">
                    <div class="mobile-hero-photo">
                        <img class="mob-photo" src="./assets/img/fede-home-mobile.png" alt="Fede" />
                    </div>
            ...
            <div id="about" class="tt-section padding-bottom-xlg-90 psi-image-is-light">
                ...
                <div class="tt-section-inner tt-wrap">
                    <h2 class="section-title hola"><span class="title-clip"><span class="title-clip-inner" id="title-hola">hola!</span></span></h2>
                    <a href="#works" data-offset="-260" id="hola-foto" class="tt-row">
                        <div class="tt-col-md-6">
                            <div class="photo">
                                <div class="film out"><div class="vectors mob-no"><img src="./assets/img/photo-vector-1.svg" class="photo-vector vector1" alt="" /><img src="./assets/img/photo-vector-2.svg" class="photo-vector vector2" alt="" /></div></div>
                                <div class="fede"><img src="./assets/img/fede.jpg" /></div>
                                <div class="film bg"><div class="vectors mob-no"><img src="./assets/img/photo-vector-1.svg" class="photo-vector vector1" alt="" /><img src="./assets/img/photo-vector-2.svg" class="photo-vector vector2" alt="" /></div></div>
                                <div class="film"><div class="vectors mob-no"><img src="./assets/img/photo-vector-1.svg" class="photo-vector vector1" alt="" /><img src="./assets/img/photo-vector-2.svg" class="photo-vector vector2" alt="" /></div></div>
                            </div>
                        </div>
                        <div class="tt-col-md-6">
                            <div class="info">
                                <p>VISUAL DESIGNER BASED IN TIGRE, ARGENTINA. EDUCATED AT UBA, WITH A BACKGROUND SPANNING BOTH INDUSTRIAL AND GRAPHIC DESIGN.</p>
                                <p>Over the past few years, I've been working on branding, web design, and UI/UX. I like creating things that not only look good but are clear and easy to use. Clean visuals, smart layouts, and designs that make sense — that's what I try to bring to every project.</p>
                            </div>
                        </div>
                    </a>
                </div>
            ...
            <div id="works" class="tt-section">
                ...
                <div class="tt-section-inner tt-wrap">
                    <h2 class="section-title mob-no"><span class="title-clip"><span class="title-clip-inner" id="title-works">featured works</span></span></h2>
                    <!-- MOBILE works phrase SVGs -->
                    ...
                    <div class="gallery">
                        <div class="card" id="frog-bazar">
                            <a href="https://www.behance.net/gallery/157959551/Frog-Bazar-2023" target="_blank" class="stamp" data-vt-mode="fade"><img src="./assets/img/stamp/project-be.svg" alt="" /><img src="./assets/img/stamp/project-be-a.svg" class="join" alt="" /><img src="./assets/img/stamp/project-be-b.svg" class="inside" alt="" /></a>
                            <a class="media" href="work/frogbazar/" alt="frog-bazar" data-vt-mode="slide"><img class="img-base" src="./assets/home/frogbazar-b.jpg" alt="Frog Bazar" /><img class="img-hover" src="./assets/home/frogbazar.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>Frog Bazar</h3><p>branding + website + photo</p><p>(001)</p><span class="meta-name">Frog Bazar</span><span class="meta-num">(001)</span></div>
                        </div>
                        <div class="card" id="estudio32">
                            <a href="http://behance.net/gallery/164603319/estudio32" target="_blank" class="stamp" data-vt-mode="fade"><img src="./assets/img/stamp/project-be.svg" alt="" /><img src="./assets/img/stamp/project-be-a.svg" class="join" alt="" /><img src="./assets/img/stamp/project-be-b.svg" class="inside" alt="" /></a>
                            <a class="media" href="work/estudio32/" alt="estudio32" data-vt-mode="slide"><img class="img-base" src="./assets/home/estudio32-b.jpg" alt="ESTUDIO 32" /><img class="img-hover" src="./assets/home/estudio32.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>ESTUDIO 32</h3><p>branding + photo</p><p>(002)</p><span class="meta-name">Estudio 32</span><span class="meta-num">(002)</span></div>
                        </div>
                        <div class="card" id="opame">
                            <a class="media" href="work/opame/" alt="opame" data-vt-mode="slide"><img class="img-base" src="./assets/home/opame-b.jpg" alt="OPAME" /><img class="img-hover" src="./assets/home/opame.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>OPAME COLLECTIVE</h3><p>website</p><p>(003)</p><span class="meta-name">Opame Collective</span><span class="meta-num">(003)</span></div>
                        </div>
                        <div class="card" id="nmp">
                            <a class="media" href="work/nmp/" alt="nmp" data-vt-mode="slide"><img class="img-base" src="./assets/home/nmp-b.jpg" alt="N.M, P" /><img class="img-hover" src="./assets/home/nmp.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>N.M,P</h3><p>branding + website</p><p>(004)</p><span class="meta-name">N.M,P</span><span class="meta-num">(004)</span></div>
                        </div>
                        <div class="card" id="cleo">
                            <a class="media" href="work/cleo/" alt="cleo" data-vt-mode="slide"><img class="img-base" src="./assets/home/cleo-b.jpg" alt="CLEO PAY" /><img class="img-hover" src="./assets/home/cleo.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>CLEO PAY</h3><p>branding</p><p>(005)</p><span class="meta-name">Cleo Pay</span><span class="meta-num">(005)</span></div>
                        </div>
                        <div class="card" id="michi">
                            <a href="https://www.behance.net/gallery/162858615/Michi-Dine-In-Take-Away" target="_blank" class="stamp" data-vt-mode="fade"><img src="./assets/img/stamp/project-be.svg" alt="" /><img src="./assets/img/stamp/project-be-a.svg" class="join" alt="" /><img src="./assets/img/stamp/project-be-b.svg" class="inside" alt="" /></a>
                            <a class="media" href="work/michi/" alt="michi" data-vt-mode="slide"><img class="img-base" src="./assets/home/michi-b.jpg" alt="MICHI BISTRO" /><img class="img-hover" src="./assets/home/michi.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>MICHI BISTRO</h3><p>concept branding</p><p>(006)</p><span class="meta-name">Michi Bistro</span><span class="meta-num">(006)</span></div>
                        </div>
                        <div class="card" id="broke">
                            <a href="https://www.behance.net/gallery/161530441/Broke-Music" target="_blank" class="stamp" data-vt-mode="fade"><img src="./assets/img/stamp/project-be.svg" alt="" /><img src="./assets/img/stamp/project-be-a.svg" class="join" alt="" /><img src="./assets/img/stamp/project-be-b.svg" class="inside" alt="" /></a>
                            <a class="media" href="work/broke/" alt="broke" data-vt-mode="slide"><img class="img-base" src="./assets/home/broke-b.jpg" alt="Broke" /><img class="img-hover" src="./assets/home/broke.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>BROKE</h3><p>branding</p><p>(007)</p><span class="meta-name">Broke</span><span class="meta-num">(007)</span></div>
                        </div>
                        <div class="card" id="big-mother-energy">
                            <a class="media" href="work/big-mother-energy/" alt="big-mother-energy" data-vt-mode="slide"><img class="img-base" src="./assets/home/big-mother-energy-b.jpg" alt="Big Mother Energy" loading="lazy" /><img class="img-hover" src="./assets/home/big-mother-energy.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>Big Mother Energy</h3><p>branding</p><p>(008)</p><span class="meta-name">Big Mother Energy</span><span class="meta-num">(008)</span></div>
                        </div>
                        <div class="card" id="ui-ux">
                            <a class="media" href="work/ui-ux/" alt="ui-ux" data-vt-mode="slide"><img class="img-base" src="./assets/home/ui-ux-b.jpg" alt="UI / UX" /><img class="img-hover" src="./assets/home/ui-ux.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>UI / UX</h3><p>(009)</p><span class="meta-name">UI / UX</span><span class="meta-num">(009)</span></div>
                        </div>
                        <div class="card" id="web">
                            <a class="media" href="work/web/" alt="web" data-vt-mode="slide"><img class="img-base" src="./assets/home/web-b.jpg" alt="Web" /><img class="img-hover" src="./assets/home/web.jpg" alt="" aria-hidden="true" /></a>
                            <div class="meta"><h3>WEB</h3><p>(010)</p><span class="meta-name">Web</span><span class="meta-num">(010)</span></div>
                        </div>
                    </div>
                </div>
            </div>
            <div id="services" class="tt-section">
                ...
                <style>
                    ...
                    .sb-tag1 { margin-top:24px; }
                    .sb-tag2 { margin-top:-50px; }
                    .sb-tag3 { margin-top:-25px; }
                    ...
                    .services-grid-item h3 { display:flex; align-items:center; gap:10px; font-family:'PP Telegraf',sans-serif; font-size:16px; font-weight:400; color:#3A3A39; letter-spacing:0; margin-bottom:12px; padding-top:0; cursor:default; transition:color 0.3s ease, transform 0.4s cubic-bezier(0.25,0.46,0.45,0.94); }
                    .services-grid-item h3 img { width:20px; height:20px; transition:filter 0.3s ease; }
                    ...
                    .services-grid-item { transition:filter 0.4s ease, opacity 0.4s ease; }
                    .services-grid:has(.services-grid-item:hover) .services-grid-item:not(:hover) { filter:blur(3px); opacity:0.4; }
                    ...
                    @media (max-width: 768px) {
                        ...
                        .services-btns { width: 100%; padding: 0 24px 40px; box-sizing: border-box; }
                        .services-btns-row { gap: 16px; }
                        .services-btns-row a { width: 100%; }
                        .services-big { margin-top: 40px; margin-bottom: 80px; }
                        .sb-tag { display: none; }
                    }
                </style>
                <div class="mob-services-phrase" style="position:relative;">
                    ...
                    <div class="mob-phrase-tags-overlay">
                        <img src="./assets/img/services-tag-complete.svg" id="mob-services-tag" class="mob-tag-complete" alt="" style="width:auto;height:auto;" />
                    </div>
                </div>
                ...
                <div class="services-grid">
                    ...
                    <div class="services-grid-item"><h3><img src="./assets/img/services-item3.svg" alt="" /> Product Design <span class="uiux-label">(UI/UX)</span></h3><p>Great design is more than looks — I create interfaces that guide, engage, and convert.</p></div>
                ...
                <div class="services-btns">
                    <div class="services-btns-row">
                        <a href="#" data-modal-open="#modal-faqs"><span style="position:relative;z-index:1;">Faqs</span></a>
                        <a href="#" data-modal-open="#modal-process"><span style="position:relative;z-index:1;">Process</span></a>
                    </div>
                ...
                <div class="tt-row" style="margin-top:180px;">
                    <div class="tt-col-md-6 d-flex-center flex-col max-width-full" style="position:relative;">
                        <!-- THEY SAID IT + SOME KIND WORDS — desktop only -->
                        ...
                        <div class="mob-somekind-phrase" style="position:relative;display:flex;flex-direction:column;align-items:center;width:100%;gap:8px;margin-bottom:8px;">
                            ...
                            <div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);pointer-events:none;z-index:2;">
                                <img src="./assets/img/testimonials-tag-complete.svg" id="mob-testi-tag" class="mob-tag-complete" alt="" style="width:auto;height:auto;" />
                            </div>
                        </div>
        ...
        <footer id="contact" class="tt-section">
            ...
            <div class="mob-footer">
                <!-- Shape fondo naranja -->
                <div class="mob-footer-shapes" style="z-index:1;">
                    <img class="mob-footer-shape-orange" src="./assets/img/mobile-footer-orange-shape.svg" alt="" />
                </div>
                <!-- Links + socials -->
                ...
                <!-- Shapes left y right encima del contenido -->
            ...
            <style>
                #contact { margin-top:-50px; overflow:visible; padding-bottom:0 !important; }
                ...
                .card a.media, .card .pgi-image-holder { position:relative; overflow:hidden; display:block; border-radius:10px 10px 0 0 !important; isolation:isolate; will-change:transform; }
                .gallery:has(.card:hover) .card:not(:hover) { filter:blur(6px); opacity:0.5; transition:filter 0.4s ease, opacity 0.4s ease; }
                ...
                .tt-section-inner.tt-wrap { padding-top:300px; }
                ...
                .footer-lb-clip:last-child { margin-top:0px; }
                ...
                @media (max-width: 768px) {
                    .footer-contact-links { grid-template-columns: 1fr; gap: 16px; text-align: center; padding: 0 24px 24px; }
                    .footer-col-right { justify-content: center; }
                    .tt-section-inner.tt-wrap { padding-top: 180px; }
                }
                @media (max-width: 768px) {
                    #contact,
                    #contact.tt-section,
            ...
            <div class="footer-letsbuild">
                ...
                <div class="footer-lb-clip" style="margin-top:0px;"><img id="lb-line2" src="./assets/img/SOMETHING.svg" alt="SOMETHING" /></div>
            </div>
        </footer>
        </div>
    </div>
...
<div class="modal-simple submmodal" id="modal-process" role="dialog" aria-modal="true" aria-hidden="true">
    ...
    <div class="modal__dialog" role="document">
        ...
        <div class="content">
            <div class="modal-item"><div><p><strong>(01)</strong> Discovery & Research</p><p class="ans">It all starts with getting to know your needs. I dive into your goals and audience, making sure we're clear on the vision and direction.</p></div></div>
            <div class="modal-item"><div><p><strong>(02)</strong> Concept & Ideation</p><p class="ans">Time to brainstorm! I sketch out ideas and share early concepts to get your input, so we're aligned from the start.</p></div></div>
            <div class="modal-item"><div><p><strong>(03)</strong> Design & Development</p><p class="ans">I bring the design to life, from wireframes to the final look. Your feedback helps me fine-tune until everything's just right.</p></div></div>
            <div class="modal-item"><div><p><strong>(04)</strong> Review & Delivery</p><p class="ans">I'll walk you through the final design, make any last tweaks, and hand over all the files. I'm here if you need further support, too!</p></div></div>
...
<div class="modal-simple submmodal" id="modal-faqs" role="dialog" aria-modal="true" aria-hidden="true">
    ...
    <div class="modal__dialog" role="document">
        ...
        <div class="content">
            <div class="modal-item"><div><p><strong>(01)</strong> Who do you usually work with?</p><p class="ans">I've worked with startups, small businesses, and larger companies in all kinds of industries: tech, retail, e-commerce, you name it.</p></div></div>
            <div class="modal-item"><div><p><strong>(02)</strong> How long does the project take?</p><p class="ans">It depends on the project. A logo might take a week or two, while a full branding package or website could take a month. I'll provide a timeline once we figure out the details.</p></div></div>
            <div class="modal-item"><div><p><strong>(03)</strong> How much do you charge?</p><p class="ans">Prices vary based on the project, but I'll give you a clear quote after we chat. No surprises, promise.</p></div></div>
            <div class="modal-item"><div><p><strong>(04)</strong> What if I want changes?</p><p class="ans">Most projects include 2-3 rounds of revisions. If you need more tweaks, we can discuss about that.</p></div></div>
            <a href="#" data-modal-close class="close">Close</a>
        </div>
    </div>
</div>
...
<script>
(function() {
    if (window.innerWidth <= 768) return; // no effect on mobile
    const REPEL_RADIUS = 220;
    const REPEL_STRENGTH = 18;
    const PUSH_NEIGHBOR = 0.25;
    ...
    document.addEventListener('mousemove', (e) => {
        ...
        cards.forEach((card, i) => {
            ...
            card.style.transition = tx === 0 && ty === 0
                ? 'transform 0.6s cubic-bezier(0.34,1.5,0.9,1), filter 0.4s ease, opacity 0.4s ease'
                : 'transform 0.15s ease, filter 0.4s ease, opacity 0.4s ease';
        });
    });
})();

document.addEventListener('click', (e) => {
    const link = e.target.closest('#modal-works a[href]:not([data-modal-close])');
    if (!link) return;
    const href = link.getAttribute('href');
    if (!href || href === '#') return;
...
window.addEventListener('load', () => {
    function matchLbHeight() {
        const lb1 = document.getElementById('lb-line1');
        const lb2 = document.getElementById('lb-line2');
        if (lb1 && lb2) {
            const h = lb2.getBoundingClientRect().height;
            lb1.style.height = h + 'px';
            lb1.style.width = 'auto';
        }
    }
    matchLbHeight();
    ...
    if (typeof gsap !== 'undefined') {
        ...
        const doReveal = () => {
            ...
            gsap.to(lineFed, { y: 0, duration: 1.4, ease: 'power4.out', delay: 0.18,
                onComplete: () => {
                    document.querySelectorAll('.name-reveal-mask').forEach(m => m.style.overflow = 'visible');
                    document.querySelectorAll('.ph-caption .min-titles').forEach(m => {
                        if (m.parentNode) m.parentNode.style.overflow = 'visible';
                    });
                }
            });
        ...
        // Esperar al preloader
        let revealed = false;
        const safeReveal = () => { if (!revealed) { revealed = true; doReveal(); } };

        const preloaderEl = document.getElementById('preloader');
        if (preloaderEl) {
            const obsReveal = new MutationObserver(() => {
                const s = window.getComputedStyle(preloaderEl);
                if (s.opacity === '0' || s.display === 'none' || s.visibility === 'hidden' || parseFloat(s.opacity) < 0.1) {
                    safeReveal();
                    obsReveal.disconnect();
                }
            });
            obsReveal.observe(preloaderEl, { attributes: true, attributeFilter: ['style', 'class'] });
            setTimeout(safeReveal, 3500);
        } else {
            setTimeout(safeReveal, 300);
        }
        ...
        (function animateViewCursor() {
            ...
            viewCursor.style.left = vcX + 'px'; viewCursor.style.top = vcY + 'px';
            viewCursor.style.transform = 'translate(-50%, -50%)';
            requestAnimationFrame(animateViewCursor);
        })();
        ...
        document.querySelectorAll('.card').forEach(card => {
            ...
            card.addEventListener('mouseenter', (e) => {
                ...
                viewCursor.style.width = '70px';
                viewCursor.style.height = '70px';
                viewCursor.style.fontSize = '12px';
                if (fxCursor) { fxCursor.style.filter='blur(4px)'; fxCursor.style.opacity='0'; }
            });
            card.addEventListener('mouseover', (e) => {
                if (e.target.closest('.stamp')) {
                    viewCursor.style.width = '10px';
                    viewCursor.style.height = '10px';
                    viewCursor.style.fontSize = '0px';
                    viewCursor.style.opacity = '0';
                    if (fxCursor) { fxCursor.style.filter='blur(0px)'; fxCursor.style.opacity='1'; }
            ...
            card.addEventListener('mouseleave', () => {
                ...
                if (fxCursor) { fxCursor.style.filter='blur(0px)'; fxCursor.style.opacity='1'; }
                if (mediaLink) {
                    mediaLink.style.transform = 'perspective(1200px) rotateX(0deg) rotateY(0deg)';
                    mediaLink.style.transition = 'transform 0.6s cubic-bezier(0.34,1.5,0.9,1)';
                }
            });
        ...
        document.querySelectorAll('.services-grid-item').forEach(item => {
            item.addEventListener('mousemove', (e) => {
                const rect = item.getBoundingClientRect();
                const dx = (e.clientX - (rect.left + rect.width/2)) / (rect.width/2);
                const dy = (e.clientY - (rect.top  + rect.height/2)) / (rect.height/2);
                item.style.transform = 'translate(' + (dx * 8) + 'px, ' + (dy * 8) + 'px)';
                item.style.transition = 'transform 0.15s ease, filter 0.4s ease, opacity 0.4s ease';
            });
            item.addEventListener('mouseleave', () => {
                item.style.transform = 'translate(0,0)';
                item.style.transition = 'transform 0.5s cubic-bezier(0.34,1.5,0.9,1), filter 0.4s ease, opacity 0.4s ease';
            });
        });
        ...
        document.querySelectorAll('.services-btns-row a, .services-btns-connect').forEach(btn => {
            btn.addEventListener('mousemove', (e) => {
                ...
                const mx = dx * 8;
                const my = dy * 8;
                btn.style.transform = 'perspective(400px) rotateX(' + (-dy*4) + 'deg) rotateY(' + (dx*4) + 'deg) translate(' + mx + 'px,' + my + 'px)';
                btn.style.transition = 'transform 0.15s ease';
            });
            btn.addEventListener('mouseleave', () => {
                btn.style.transform = 'perspective(400px) rotateX(0deg) rotateY(0deg) translate(0px,0px)';
                btn.style.transition = 'transform 0.5s cubic-bezier(0.34,1.5,0.9,1)';
            });
        });

        if (window.innerWidth > 768) {
            document.querySelectorAll('.tt-ol-menu-list > li.common-li > a, .tt-ol-submenu-list > li > a').forEach(a => {
                const text = a.textContent.trim();
                a.innerHTML = '<span class="ol-roll-wrap"><span class="ol-brace ol-brace-l">[</span><span class="ol-roll-text"><span>' + text + '</span><span>' + text + '</span></span><span class="ol-brace ol-brace-r">]</span></span>';
            });
        }
        ...
        (function() {
            ...
            styleTag.textContent = '.trusted-track img { cursor: default; }';
            document.head.appendChild(styleTag);

            let hoveredImg = null;

            container.addEventListener('mouseover', (e) => {
                const img = e.target.closest('.trusted-track img');
                if (!img || img === hoveredImg) return;
                if (hoveredImg) {
                    hoveredImg.style.filter = 'none';
                    hoveredImg.style.transform = 'scale(1) translate(0,0)';
                    hoveredImg.style.transition = 'filter 0.4s ease, transform 0.5s cubic-bezier(0.34,1.5,0.9,1)';
                }
                hoveredImg = img;
                img.style.transition = 'filter 0.2s ease, transform 0.2s cubic-bezier(0.34,1.5,0.9,1)';
                img.style.filter = 'brightness(0) saturate(100%) invert(45%) sepia(99%) saturate(700%) hue-rotate(1deg) brightness(103%)';
            ...
            container.addEventListener('mousemove', (e) => {
                ...
                const dx = (e.clientX - (rect.left + rect.width/2)) / (rect.width/2);
                const dy = (e.clientY - (rect.top + rect.height/2)) / (rect.height/2);
                img.style.transform = 'scale(1.18) translate(' + (dx*5) + 'px,' + (dy*5) + 'px)';
                img.style.transition = 'filter 0.2s ease, transform 0.1s ease';
            });
            ...
            container.addEventListener('mouseout', (e) => {
                ...
                img.style.transition = 'filter 0.4s ease, transform 0.5s cubic-bezier(0.34,1.5,0.9,1)';
            });
        })();
        ...
        document.querySelectorAll('.footer-contact-socials a').forEach(a => {
            a.addEventListener('mousemove', (e) => {
                ...
                const dx = (e.clientX - (rect.left + rect.width/2)) / (rect.width/2);
                const dy = (e.clientY - (rect.top  + rect.height/2)) / (rect.height/2);
                a.style.transform = 'translateY(-4px) scale(1.15) translate(' + (dx*4) + 'px,' + (dy*4) + 'px)';
                a.style.transition = 'transform 0.15s ease';
            });
            a.addEventListener('mouseleave', () => {
                a.style.transform = '';
                a.style.transition = 'transform 0.4s cubic-bezier(0.34,1.5,0.9,1)';
            });
        });

        (function() {
            [['#title-hola','#about'],['#title-works','#works']].forEach(([id, trigger]) => {
        ...
        (function() {
            window.__registerTitleParallax = function() {};
        })();

        (function() {
            const line1 = document.getElementById('lb-line1');
            const line2 = document.getElementById('lb-line2');
        ...
        (function() {
            ...
            gsap.to(testiPhrase, { y: 0, ease: 'none',
                scrollTrigger: { trigger: '.desktop-testi-wrap', start: 'top bottom', end: 'center center', scrub: 1.2 }
            });
        })();

        const servicesBig = document.querySelector('.services-big');
        if (servicesBig) {
            [['.sb-line1',-180,0.8],['.sb-line2',-120,0.8],['.sb-line3',-70,0.8],['.sb-tag1',-40,0.25],['.sb-tag2',-20,0.3],['.sb-tag3',-8,0.35]].forEach(([sel,y,scrub]) => {
                const el = servicesBig.querySelector(sel);
                if (!el) return;
        ...
        if (testiTag) {
            ...
            [['img:nth-child(1)',-25,0.25],['img:nth-child(2)',-15,0.3],['img:nth-child(3)',-8,0.35]].forEach(([sel,y,scrub]) => {
                const el = testiTag.querySelector(sel);
                if (!el) return;
                gsap.to(el, { y, ease:'none', scrollTrigger: { trigger: testiWrap, start:'top bottom', end:'bottom top', scrub } });
            });
        }
...
<script>
if (window.innerWidth <= 768) {
    // Prevenir scroll al cerrar menu — capture phase
    document.addEventListener('click', function(e) {
        var btn = e.target.closest('.tt-ol-menu-toggle-btn');
...
if (window.innerWidth <= 768) {
    ...
    var mobileText = document.querySelector('.mobile-hero-text');
    var mobilePhoto = document.querySelector('.mob-photo-wrap');
    var mobAbout = document.querySelector('.mob-about-block');
    ...
    function revealMobileHero() {
        var label = document.querySelector('.mobile-hero-portfolio-label-inner');
        var fed = document.getElementById('mob-federico');
        var vac = document.getElementById('mob-vaccarezza');
        ...
        setTimeout(function() {
            if (mobilePhoto) mobilePhoto.classList.add('revealed');
        }, 360);
    ...
    if (preloader) {
        var obs = new MutationObserver(function() {
            var style = window.getComputedStyle(preloader);
            if (style.opacity === '0' || style.display === 'none' || style.visibility === 'hidden') {
                revealMobileHero();
                obs.disconnect();
            }
        });
        obs.observe(preloader, { attributes: true, attributeFilter: ['style', 'class'] });
        setTimeout(revealMobileHero, 1800);
    } else {
        setTimeout(revealMobileHero, 500);
    }
}

// Mobile photo mask removed

if (window.innerWidth <= 768) {
    var mobileTesti = document.querySelector('.mobile-testimonials');
    if (mobileTesti) mobileTesti.style.display = 'flex';
    var wordsContainer = document.querySelector('.words-container');
    if (wordsContainer) wordsContainer.style.display = 'none';

    // Reveal about block
    var aboutSvg = document.getElementById('mob-about-svg');
    var aboutText = document.querySelector('.mob-about-text');
    if (aboutSvg) {
        ...
        }, { threshold: 0.0 }).observe(aboutSvg);
    }
    if (aboutText) {
        new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
        ...
        }, { threshold: 0.0 }).observe(aboutText);
    }
    ...
    // Phrase words — each word reveals individually as it scrolls into view
    var phraseClips = document.querySelectorAll('.mob-phrase-clip');
    if (phraseClips.length) {
        var phraseWordObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    var word = entry.target.querySelector('.mob-phrase-word');
                    if (word) word.classList.add('in-view');
                    phraseWordObserver.unobserve(entry.target);
                }
            });
        }, { threshold: 0.0, rootMargin: '0px 0px 0px 0px' });
        phraseClips.forEach(function(clip) {
            phraseWordObserver.observe(clip);
        });
    }

    // Services grid items reveal
    ...
    if (serviceItems.length) {
        var servicesObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    var idx = Array.from(serviceItems).indexOf(entry.target);
                    setTimeout(function() {
                        entry.target.classList.add('in-view');
                    }, idx * 80);
    ...
    if (connectBtn) {
        ...
        }, { threshold: 0.3 }).observe(connectBtn);
    }

    // Reveal featured works subtitle
    var subtitleWorks = document.getElementById('mob-works-subtitle');
    if (subtitleWorks) {
        new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) { entry.target.classList.add('in-view'); }
            });
        }, { threshold: 0.3 }).observe(subtitleWorks);
    }

    // Reveal featured works title
    var titleWorks = document.getElementById('title-works');
    if (titleWorks) {
        new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) { entry.target.classList.add('in-view'); }
            });
        }, { threshold: 0.3 }).observe(titleWorks);
    }

    // Reveal + parallax testimonials tag
    var testiTag = document.getElementById('mob-testi-tag');
    if (testiTag) {
        var testiTagObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    testiTag.classList.add('in-view');
                    testiTagObserver.disconnect();
                }
            });
        }, { threshold: 0.3 });
        testiTagObserver.observe(testiTag);

        window.addEventListener('scroll', function() {
            var rect = testiTag.getBoundingClientRect();
            var centerOffset = (rect.top + rect.height / 2) - (window.innerHeight / 2);
            var parallaxY = centerOffset * 0.06;
            testiTag.style.transform = 'scale(1.2) translateY(' + parallaxY + 'px)';
        }, { passive: true });
    }

    // Reveal testimonials phrase SVGs
    var someKindClips = document.querySelectorAll('.mob-somekind-phrase .mob-phrase-clip');
    if (someKindClips.length) {
        var someKindObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    var word = entry.target.querySelector('.mob-phrase-word');
                    if (word) word.classList.add('in-view');
                    someKindObserver.unobserve(entry.target);
                }
            });
        }, { threshold: 0.0 });
        someKindClips.forEach(function(clip) { someKindObserver.observe(clip); });
    }

    // Reveal works phrase SVGs — mismo sistema que someKind
    var worksClips = document.querySelectorAll('.mob-works-phrase .mob-phrase-clip');
    if (worksClips.length) {
        var worksObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    var word = entry.target.querySelector('.mob-phrase-word');
                    if (word) word.classList.add('in-view');
        ...
        worksClips.forEach(function(clip) { worksObserver.observe(clip); });
    }

    // Works tag — reveal + parallax, mismo que testiTag
    var worksTag = document.getElementById('mob-works-tag');
    if (worksTag) {
        function positionWorksTag() {
            var redClip = document.getElementById('mob-works-red-clip');
            var phrase = document.querySelector('.mob-works-phrase');
            if (!redClip || !phrase) return;
            var phraseTop = phrase.getBoundingClientRect().top + window.scrollY;
            var redTop = redClip.getBoundingClientRect().top + window.scrollY;
            var redCenter = redTop + redClip.offsetHeight / 2;
            worksTag.style.top = (redCenter - phraseTop - worksTag.offsetHeight / 2) + 'px';
        }
        setTimeout(positionWorksTag, 200);
        window.addEventListener('resize', positionWorksTag);

        var worksTagObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    worksTag.classList.add('in-view');
                    worksTagObserver.disconnect();
                }
            });
        }, { threshold: 0.3 });
        worksTagObserver.observe(worksTag);

        window.addEventListener('scroll', function() {
            var rect = worksTag.getBoundingClientRect();
            var centerOffset = (rect.top + rect.height / 2) - (window.innerHeight / 2);
            var parallaxY = centerOffset * 0.06;
            worksTag.style.transform = 'translateX(-50%) translateY(' + parallaxY + 'px)';
        }, { passive: true });
    }

    // Reveal testimonial images staggered
    ...
    if (testiImgs.length) {
        var testiObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    var idx = Array.from(testiImgs).indexOf(entry.target);
                    setTimeout(function() {
                        entry.target.classList.add('in-view');
                    }, idx * 100);
        ...
        testiImgs.forEach(function(img) { testiObserver.observe(img); });
    }

    // Footer words reveal — staggered on scroll
    var footerClips = document.querySelectorAll('.mob-footer-clip');
    if (footerClips.length) {
        var footerTriggered = false;
        var footerObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting && !footerTriggered) {
                    footerTriggered = true;
                    footerClips.forEach(function(clip, idx) {
                        setTimeout(function() {
                            var word = clip.querySelector('.mob-footer-word');
                            if (word) word.classList.add('in-view');
                        }, idx * 120);
                    });
        ...
        footerClips.forEach(function(clip) {
            footerObserver.observe(clip);
        });
    }

    // Fade in services-tag-complete when near end of phrase SVGs
    var servicesTag = document.getElementById('mob-services-tag');
    if (servicesTag) {
        var servicesTagObserver = new IntersectionObserver(function(entries) {
            entries.forEach(function(entry) {
                if (entry.isIntersecting) {
                    servicesTag.classList.add('in-view');
                    servicesTagObserver.disconnect();
                }
            });
        }, { threshold: 0.3 });
        servicesTagObserver.observe(servicesTag);

        window.addEventListener('scroll', function() {
            var rect = servicesTag.getBoundingClientRect();
            var centerOffset = (rect.top + rect.height / 2) - (window.innerHeight / 2);
            var parallaxY = centerOffset * 0.06;
            servicesTag.style.transform = 'translateY(' + parallaxY + 'px)';
        }, { passive: true });
    }

    // Parallax leve en shapes del footer
    var shapeLeft = document.getElementById('footer-shape-left');
    var shapeRight = document.getElementById('footer-shape-right');
    if (shapeLeft || shapeRight) {
        window.addEventListener('scroll', function() {
            if (shapeLeft) {
                var rectL = shapeLeft.getBoundingClientRect();
                var offsetL = (rectL.top + rectL.height / 2) - (window.innerHeight / 2);
                shapeLeft.style.transform = 'translateY(' + (offsetL * 0.12) + 'px)';
            }
            if (shapeRight) {
                var rectR = shapeRight.getBoundingClientRect();
                var offsetR = (rectR.top + rectR.height / 2) - (window.innerHeight / 2);
                shapeRight.style.transform = 'translateY(' + (offsetR * -0.12) + 'px)';
            }
        }, { passive: true });
    }
}

// DESKTOP REVEAL — cards y services grid
if (window.innerWidth > 768) {
    var desktopStyle = document.createElement('style');
    desktopStyle.textContent = [
        '.gallery .card { opacity:0; transform:translateY(20px); transition:opacity 1.6s cubic-bezier(0.25,0.46,0.45,0.94), transform 1.6s cubic-bezier(0.25,0.46,0.45,0.94); }',
        '.gallery .card.in-view { opacity:1; transform:translateY(0); }',
        '.services-grid-item { opacity:0; transform:translateY(16px); transition:opacity 1.6s cubic-bezier(0.25,0.46,0.45,0.94), transform 1.6s cubic-bezier(0.25,0.46,0.45,0.94); }',
        '.services-grid-item.in-view { opacity:1; transform:translateY(0); }'
    ].join('');
    document.head.appendChild(desktopStyle);

    var desktopCards = document.querySelectorAll('.gallery .card');
    var desktopCardObs = new IntersectionObserver(function(entries) {
        entries.forEach(function(entry) {
            if (entry.isIntersecting) {
                var idx = Array.from(desktopCards).indexOf(entry.target);
                entry.target.style.transitionDelay = (idx * 0.06) + 's';
                entry.target.classList.add('in-view');
                desktopCardObs.unobserve(entry.target);
            }
        });
    }, { threshold: 0.1 });
    ...
    var desktopServicesObs = new IntersectionObserver(function(entries) {
        entries.forEach(function(entry) {
            if (entry.isIntersecting) {
                var idx = Array.from(desktopServices).indexOf(entry.target);
                setTimeout(function() { entry.target.classList.add('in-view'); }, idx * 100);
                desktopServicesObs.unobserve(entry.target);
            }
        });
    }, { threshold: 0.1 });
