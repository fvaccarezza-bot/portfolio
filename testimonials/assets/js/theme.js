...
(function ($) {
   ...
   if ($('body').hasClass('tt-transition')) {
      ...
      function HideLoad() {
         ...
         tl_transitOut.to(
            '.ptr-overlay',
            { duration: 1, scaleY: 0, transformOrigin: 'center top', ease: Expo.easeInOut },
            0.3
         );
         ...
         tl_transitOut.from(
            '#tt-header',
            { duration: 1, y: 20, autoAlpha: 0, ease: Expo.easeInOut, clearProps: 'all' },
            0.6
         );
         ...
         if ($('#page-header .project-info-list').length) {
            if ($('#page-header').hasClass('ph-inline')) {
               ...
               tl_transitOut.from(
                  ...
                  { duration: 1.5, y: 80, autoAlpha: 0, ease: Expo.easeOut, clearProps: 'all' },
                  2.2
               );
            }
         }
         ...
         if ($('.tt-pci-category').length) {
            tl_transitOut.from(
               '.tt-pci-category',
               { duration: 1.5, x: 80, autoAlpha: 0, ease: Expo.easeOut, clearProps: 'all' },
               1.5
            );
         }
         ...
         if ($portfolioHoverCarousel.length) {
            ...
            if ($portfolioHoverCarouselCounter.length) {
               tl_transitOut.from(
                  ...
                  { duration: 2, y: 20, autoAlpha: 0, ease: Expo.easeInOut, clearProps: 'all' },
                  0.4
               );
            }
         ...
         tl_transitOut.from(
            '#page-content',
            { duration: 1.5, autoAlpha: 0, y: 80, ease: Expo.easeOut, clearProps: 'all' },
            0.8
         );
   ...
   gsap.utils.toArray('.tt-lazy').forEach((image) => {
      let newSRC = image.dataset.src,
        ...
        st = ScrollTrigger.create({
          ...
          start: "-50% bottom",
          onEnter: loadImage,
          onEnterBack: loadImage, // make sure it work in either direction
        });
   });
      ...
      if ($('body').hasClass('tt-m-menu-open')) {
         ...
         $('.tt-main-menu a, .tt-logo a')
            ...
            .on('click', function () {
               ...
               tl_MenuClick.to('.tt-main-menu-list > li', {
                  duration: 0.4,
                  y: -80,
                  autoAlpha: 0,
                  stagger: 0.05,
               ...
               tl_MenuClick.to('#content-wrap, .ttgr-cat-nav', {
                  duration: 0.4,
                  autoAlpha: 1,
                  clearProps: 'all',
               });
      ...
      if ($('body').hasClass('tt-ol-menu-open')) {
         ...
         $('.tt-overlay-menu a, .tt-logo a')
            ...
            .on('click', function () {
               ...
               tl_olMenuClick.to('#content-wrap, .ttgr-cat-nav', {
                  duration: 0.4,
                  autoAlpha: 1,
                  clearProps: 'all',
               });
               tl_olMenuClick.to('.tt-overlay-menu', {
                  duration: 0.4,
                  autoAlpha: 0,
                  clearProps: 'all',
               });
            ...
            on: {
               ...
               transitionStart: function () {
                  ...
                  gsap.fromTo(
                     ...
                     { autoAlpha: 1, y: 0 },
                     { duration: 0.25, autoAlpha: 0, y: -30, stagger: 0.15, ease: Power1.easeIn }
                  );
               },
               ...
               transitionEnd: function () {
                  ...
                  gsap.fromTo(
                     $ttPortfolioSlider.find('.tt-psc-elem'),
                     { autoAlpha: 0, y: 30 },
                     { duration: 0.25, autoAlpha: 1, y: 0, stagger: 0.15, ease: Power1.easeOut }
                  );
               },
            },
         });
   ...
   $('.pli-info').each(function () {
      ...
      if ($($pliTitle).length) {
         tl_plIInfo.from(
            $pliTitle,
            { duration: 2.5, autoAlpha: 0, y: 80, ease: Expo.easeOut, clearProps: 'all' },
            '+=0.5'
         );
      }
      if ($($pliCategory).length) {
         tl_plIInfo.from(
            $pliCategory,
            { duration: 2.5, autoAlpha: 0, y: 60, ease: Expo.easeOut, clearProps: 'all' },
            '-=2.2'
         );
      }
      if ($($pliCounter).length) {
         tl_plIInfo.from(
            $pliCounter,
            { duration: 2.5, autoAlpha: 0, y: 40, ease: Expo.easeOut, clearProps: 'all' },
            '-=2.2'
         );
      }
   });
   ...
   $('.anim-fadeinup').each(function () {
      ...
      tl_FadeInUp.from(
         this,
         { duration: 2.5, autoAlpha: 0, y: 100, ease: Expo.easeOut, clearProps: 'all' },
         '+=0.3'
      );
   });
   ...
   if ($('body').not('.is-mobile').hasClass('tt-magic-cursor')) {
      if ($(window).width() > 1024) {
         ...
         function callParallax(e, parent) {
            parallaxIt(e, parent, parent.querySelector('.magnetic-item'), 10); // magnetic area = higher number is more attractive
         }
